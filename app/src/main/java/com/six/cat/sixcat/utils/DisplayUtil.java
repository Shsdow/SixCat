...
public class DisplayUtil {
    ...
    public static int dp2px(float dipValue) {
        return (int) (dipValue * SixCatApplication.getInstance().getApplicationContext().getResources().getDisplayMetrics().density + 0.5f);
    }
    ...
    public static int sp2px(float spValue) {
        return (int) (spValue *  SixCatApplication.getInstance().getApplicationContext().getResources().getDisplayMetrics().scaledDensity + 0.5f);
    }
    ...
    public static SpannableString changeTextColor(String text, int colorId, int start, int end) {
        ...
        sp.setSpan(new ForegroundColorSpan(
                        ContextCompat.getColor(SixCatApplication.getInstance(), colorId)), start, end,
                Spanned.SPAN_INCLUSIVE_EXCLUSIVE);
        return sp;
    }
