    ...
    class Builder  constructor(private var text: CharSequence?) {
        ...
        private fun setSpan() {
            ...
            if (imageIsBitmap || imageIsDrawable || imageIsUri || imageIsResourceId) {
                if (imageIsBitmap) {
                    mBuilder.setSpan(ImageSpan(SixCatApplication.context, bitmap), start, end, flag)
                    bitmap = null
                    imageIsBitmap = false
                    ...
                    mBuilder.setSpan(ImageSpan(SixCatApplication.context, uri), start, end, flag)
                    uri = null
                    imageIsUri = false
                } else {
                    mBuilder.setSpan(ImageSpan(SixCatApplication.context, resourceId), start, end, flag)
                    resourceId = 0
